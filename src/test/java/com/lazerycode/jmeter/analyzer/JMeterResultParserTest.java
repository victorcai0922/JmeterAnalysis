...
public class JMeterResultParserTest extends TestCase {
  ...
  public void testSuccess() throws Exception {
    ...
    Reader data = new FileReader("E:/jmeter-analysis-maven-plugin/src/test/resources/com/lazerycode/jmeter/analyzer/PoscPaymentServiceImplService-120611.jtl");
    Map<String, AggregatedResponses> result = a.aggregate(data);
  ...
  public void testSomeErrors() throws Exception {
    ...
    JMeterResultParser a = new JMeterResultParser();
    Reader data = new FileReader("E:/jmeter-analysis-maven-plugin/src/test/resources/com/lazerycode/jmeter/analyzer/test-120611.jtl");
    Map<String, AggregatedResponses> result = a.aggregate(data);
